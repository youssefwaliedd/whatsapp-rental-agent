...
TOOLS: list[dict[str, Any]] = [
    ...
    _tool(
        ...
        "incident is not. "
        "But a question about what WOULD happen is not an incident. 'What happens if "
        "I crash it?', 'what if it breaks down?', 'am I covered for...' are ordinary "
        "questions from someone deciding whether to book — answer them from "
        "search_company_policy, which has the excess, the police report requirement "
        "and what insurance excludes. Escalating a hypothetical ends the sale and "
        "sends your colleague a case with nothing in it to act on. "
